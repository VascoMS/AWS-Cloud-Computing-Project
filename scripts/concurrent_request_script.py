...
server_url = f"http://{webserver_ip}:8000/fifteenpuzzle?shuffles=105&size=10"
...
async def main():
    async with aiohttp.ClientSession() as session:
        tasks = [make_request(session, server_url) for _ in range(1)]  # Adjust number of requests here
